...
public class ProcesoClienteCuellar extends Proceso{
	...
	public void run(){
		...
		while(continuar())// aqui deberia ir una bandera o lo de continuar()
		{
		  ...
		  // byte dato;
		   ...
		   imprimeln("el servidor me envió:  "+  mensajeDeLaRed);
		   else
		   {
		   ...
		   // aqui deveriamos volver hacer verdadero el boton
   ...
   public int construyeInt(byte arreglo[]){
		//System.out.println("Arreglo");
	       ...
	       /* System.out.println("pos 0 = "+arreglo[0]);
	       System.out.println("pos 1 = "+arreglo[1]);
	       System.out.println("pos 2 = "+arreglo[2]);
	       System.out.println("pos 3 = "+arreglo[3]);*/
