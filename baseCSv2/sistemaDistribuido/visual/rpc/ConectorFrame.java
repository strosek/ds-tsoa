...
class PanelConexion extends Panel {
  ...
  * 
  */
    public PanelConexion(Checkbox seleccion, String nombreServidor,
            String version, String ip, String id, int identificacionUnica) {
...
public class ConectorFrame extends Frame implements DespleganteConexiones,
        WindowListener {
    private static final long serialVersionUID = 1;
    ...
    */
        public void actionPerformed(ActionEvent e) {
            ...
            if (com.equals(agregarStr)) {
                agregarDesdeInterfazGrafica(campoNombre.getText(),
                        campoVersion.getText(), campoIP.getText(),
                        campoID.getText());
                campoNombre.setText("");
  ...
  * 
  */
    private void agregarDesdeInterfazGrafica(String nombreServidor,
            String version, String ip, String idProceso) {
        agregar(nombreServidor, version, ip, idProceso); // devuelve un contador
                                                         // secuencial de
                                                         // agregados a la
                                                         // interfaz gr�fica
  ...
  * 
  */
    public int agregarServidor(String nombreServidor, String version,
            String ip, String idProceso) {
  ...
  */
    public void removerServidor(int llaveInterfaz) {
        PanelConexion p = (PanelConexion) tablaConexiones.remove(new Integer(
                llaveInterfaz));
        if (p != null) {
